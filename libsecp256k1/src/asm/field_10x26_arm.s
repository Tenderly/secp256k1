...
*/
	...
	.align	2
	.global lw_secp256k1_fe_mul_inner
	.type	lw_secp256k1_fe_mul_inner, %function
	@ Arguments:
...
lw_secp256k1_fe_mul_inner:
	...
	*/
	...
	.size	lw_secp256k1_fe_mul_inner, .-lw_secp256k1_fe_mul_inner

	.align	2
	.global lw_secp256k1_fe_sqr_inner
	.type	lw_secp256k1_fe_sqr_inner, %function
	@ Arguments:
...
lw_secp256k1_fe_sqr_inner:
	...
	*/
	...
	add	sp, sp, #48
	ldmfd	sp!, {r4, r5, r6, r7, r8, r9, r10, r11, pc}
	.size	lw_secp256k1_fe_sqr_inner, .-lw_secp256k1_fe_sqr_inner
